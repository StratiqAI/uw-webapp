 ...
 */
export const REGION_PRESETS: ReadonlyArray<{
	label: string;
	fips: string;
	city: string;
	state: string;
 ...
 */
export async function resolveAreaFips(
	input: { city: string; state: string; zip?: string },
