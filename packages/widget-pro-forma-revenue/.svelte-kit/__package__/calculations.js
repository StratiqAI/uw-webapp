 ...
 */
export function computeRevenueProjections(config) {
    const { unitType, totalUnits, totalSqFt, marketRentPerUnit, rentGrowthRate, vacancyRate, otherIncomeAnnual, otherIncomeGrowthRate, projectionYears } = config;
