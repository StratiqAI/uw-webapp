...
<div
	class="title-widget relative flex h-full flex-col justify-center overflow-hidden px-6 text-{widgetData.alignment ||
		'left'} {darkMode ? 'bg-transparent' : 'bg-transparent'}"
>
	{#if darkMode}
		<div
