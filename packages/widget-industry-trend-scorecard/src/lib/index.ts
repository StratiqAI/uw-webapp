...
export const industryTrendScorecardWidget = defineWidget({
	...
	promptConfig: {
		...
		systemInstruction:
			'You are an economic research analyst. Return quarterly industry trend data including employment, location quotient, wage, and establishment year-over-year changes for key industries.',
...
export type {
	...
	IndustryTrendScorecardAiOutput,
	IndustryData,
	QuarterMetrics,
	ScoreWeights,
	LqTrend
...
export {
	...
	industryTrendScorecardAiOutputSchema,
	industryDataSchema,
