...
export const mapbox3dWidget = defineWidget({
    ...
    promptConfig: {
        defaultPrompt: 'What is the full street address or property address shown in the document? Include the street number, street name, city, state, and ZIP code. Then determine the best 3D map view coordinates for that address.',
        systemInstruction: 'You are a commercial real estate document analyst. Search the provided document pages for the property address. ' +
