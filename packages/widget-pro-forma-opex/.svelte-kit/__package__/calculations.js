 ...
 */
export function computeOpExProjections(config) {
    const { unitType, totalUnits, totalSqFt, egiYear1, egiGrowthRate, baseOperatingExpenses, expenseGrowthRate, managementFeeRate, reservePerUnit, applyGrowthToReserves, customExpenses, projectionYears } = config;
