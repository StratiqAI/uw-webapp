...
export const econBaseMultiplierWidget = defineWidget({
	...
	promptConfig: {
		...
		systemInstruction:
			'You are an economic analyst. Return industry employment data with NAICS codes, local and national employment counts for computing location quotients and economic base multipliers.',
