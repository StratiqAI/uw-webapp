<script lang="ts">
	...
	const getMenuItems = (
		...
		if (widget.type === 'table' || widget.type === 'lineChart' || widget.type === 'barChart' || widget.type === 'donutChart' || widget.type === 'areaChart' || widget.type === 'gauge' || widget.type === 'sparkline' || widget.type === 'heatmap' || widget.type === 'divergingBarChart' || widget.type === 'locationQuotient') {
			items.push({
